...
public class UnitTests { 
    ...
    public void countPassed(){ 
        ...
        if (passed == 13) 
            System.out.println(systemCall("curl -k    https://cs.gmu.edu/~kdobolyi/sparc/process.php?user=sparc_HP16I7V612345678-project2_0-COMPLETED"));             
        else 
            System.out.println(systemCall("curl -k    https://cs.gmu.edu/~kdobolyi/sparc/process.php?user=sparc_HP16I7V612345678-project2_0-PROGRESS"));                 
    }     
